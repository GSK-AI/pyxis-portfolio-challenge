...
# All feature configs (except rd_capacity, passed explicitly) as disabled instances,
# required now that GameState.initialise_new_game takes them as keyword-only args.
